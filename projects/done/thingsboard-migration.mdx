...
position: 4
preview:
  { image: '/projects/thingsboard-migration.svg', imageAlt: 'Thingsboard Migration' }
---
...
<Techs
  ...
  postgres={{ src: '/icons/postgres.svg', w: 50, h: 50 }}
...
<Image 
  src='/projects/thingsboard-migration.svg'
  alt='Thingsboard Migration'
  width={1200}
  height={650}
  loading='lazy'
  className='mx-auto'
