...
const Techs = (props) => {
    ...
    return (
        <div className="grid grid-cols-24 max-w-screen-2xl p-0 w-full mt-6 mb-24">
            <div
                className={`item ${
                    techs.length < 4 ? 'col-start-5 col-end-21' : 'col-start-2 col-end-24'
                }  md:col-start-5 md:col-end-21 lg:pb-0`}
            >
                <div className="flex items-start justify-between md:pt-6">
                    {techs.map((tech) => {
                        ...
                        return (
                            <div key={alt} className="flex flex-col justify-center items-center">
